...
@section('title', 'Lealum S.A.- Productos')
@section('css')
...
@section('contenido')
    ...
    <a href="{{ url('presupuesto/'.$p->id) }}">
        <button class="pedido btn btn-default left" style="background-color: white;height: 39px;width: 213px;color: #278CCC;height: 39px;border: 1px solid;font-family: 'Source Sans Pro', sans-serif;">
            <span class="rpedido">
...
@if($p->modelos && $categoria->nombre == 'Ventanas de Aluminio')
    <div class="row">
    <div class="col s12">
      <ul class="tabs">
