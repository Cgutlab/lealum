...
@section('title', 'Lealum S.A. - Obras')
@section('css')
...
<div class="container" style="width: 89%">
  ...
  <div id="modal{!! $obra->id !!}" class="modal" style="height: 555px!important;max-height: 950px!important; " style="height: 558px!important;max-height: 571px!important;">
    <div class="modal-content">
        <h4 style="font-family: 'Source Sans Pro', sans-serif;font-size: 26px;color: #278CCC;">{!! $obra->nombre !!}<a href="#!" class="right modal-close waves-effect waves-green btn-flat" style="font-family: 'Source Sans Pro', sans-serif;font-size: 14px;color: #777777;font-weight: bold;margin-bottom: 5%;">Cerrar</a></h4>
        <div class="row">
            <div class="col l12 m12 s12" style="padding-left: 0px;">   
                <div class="cont-ser">
                                        <div class="row imggrande">
                                            <div class="col s12" style="padding-left: 0px;">
                                                @foreach($obra->imagenes as $key => $imagen)
                                                <div class="cont-img">
                                                    <img alt="" class="responsive-img element" id="obra-{!! $obra->id !!}" src="{{asset($imagen->imagen)}}" style="width: 486px;height: 305px;border:1px solid #AAAAAA;top: 2%!important;">
                                            ...
                                            <div class="col s12" style="padding-left: 0px;padding-right: 0px;">
                                                ...
                                                <div class="col l3 s3 m3" style="padding-left: 0px;">
                                                    <div class="cont-img">
                                                        ...
                                                        <img alt="" class="responsive-img" onclick="actualizar('{{asset($imagen->imagen)}}', '{{ $obra->id }}')" src="{{asset($imagen->imagen)}}" style="border: 1px solid #AAAAAA; width: 110px;">
                                                    </div>
                                                </div>
                                                @endforeach
                                            </div>
...
<script type="text/javascript">
  ...
  function actualizar(imagen, key){
    var productos = document.getElementsByClassName('element');
    id = 'obra-'+key;
    productos.namedItem(id).src = imagen
    }
</script>
@endsection
