...
<div class="formulario_servicios">
    <div class="container" style="width: 100%;">
        <div class="row" style="">
            <div class="contenido-mtto col s12 m12 l12">
                <div class="titulo-mtto col s12 m12 l12 center">
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col s6">
                                    ...
                                    <button class="btn waves-effect waves-light z-depth-0" type="submit" name="action" style="background-color: white;height: 39px;width: 183px;color: #278CCC;    border: 1px solid;font-family: 'Source Sans Pro', sans-serif;position: relative;left: 51%;">Enviar
                                    </button>
                                </div>
                            </div>
                {!!Form::close()!!}
