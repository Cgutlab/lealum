...
@section('title', 'Lealum S.A. - Trabaja con nosotros')
@section('css')
...
<!-- body -->        
	...
	<main>			
		<section class="contacto">
			<div class="container">
				<h1 class="center" style="color: #278CCC; font-size: 47px; font-family: 'Source Sans Pro', sans-serif;">Trabaje con Nosotros</h1>
				<div style="margin-top: 20px; margin-bottom: 20px; color: #6F6F6F;;">Complete el siguiente formulario, adjunte el CV y nos contactaremos a la brevedad</div>
				...
				<div class="row">
                  ...
                  {{ csrf_field() }}
					      	...
					      	<div class="row">
					        	...
					        	<div class="input-field col m6 s12" style="color: black">
					          		{!!Form::email('email',null,['class'=>'', 'placeholder'=>'E-mail', 'required'])!!}
					          		<label for="email"></label>
					        	</div>
					      	</div>
					      	<div class="row">
					        	<div class="input-field col m6 s12" style="color: black">
					          		{!!Form::text('documento',null,['class'=>'', 'placeholder'=>'Numero de documento', 'required'])!!}
